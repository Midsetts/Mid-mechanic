...
bennyGarages = {
    [1] = {coords = vector4(145.35, -3047.2, 7.04, 7.46), blip = true, useJob = false, job = {"mechanic", "police"}},
    [2] = {coords = vector4(135.86, -3030.24, 7.04, 178.21), blip = false, useJob = true, job = {"mechanic"}}
}

--[[ bennyLocations = {
    vector4(156.21, -3028.72, 7.03, 286.66)
} ]]
